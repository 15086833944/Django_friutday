    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('good', models.ForeignKey(db_column='good_id', to='memberapp.Goods',on_delete=models.CASCADE)),
                ('user', models.ForeignKey(db_column='user_id', to='userinfo.UserInfo',on_delete=models.CASCADE)),
            ],
            options={
                'db_table': 'cartinfo',
            },
